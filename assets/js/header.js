        ...
        <div id="zone1">
          ...
          <nav class="navTop">
            <ul class="navTop_menu">
              <li>
                <a class="${current === "index" ? 'active' : ''}" href="index.html">Accueil</a>
              </li>
              <li>
                <a class="${current === "quisuis-je" ? 'active' : ''}" href="about.html">Qui suis-je?</a>
              </li>
              <li>
              ...
              <li>
                <a class="${current === "accueil" ? 'active' : ''}" href="news-agenda.html">Les news/Agenda</a>
              </li>
              <li>
            ...
            <nav class="navBottom">
              <ul>
                ...
                <li class="navCat"><a href="panier_achats.html">
